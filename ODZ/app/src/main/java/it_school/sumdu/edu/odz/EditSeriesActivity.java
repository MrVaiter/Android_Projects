...
public class EditSeriesActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onClick(View view) {
        if(view.getId() == R.id.backBtn){
            Intent intent = new Intent(EditSeriesActivity.this, EditorActivity.class);
